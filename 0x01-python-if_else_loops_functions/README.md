...
* **0. Positive anything is better than negative nothing**
  ...
  * Completion of [this source code](https://github.com/ALXschool/0x01.py/blob/master/0-positive_or_negative_py).
...
* **1. The last digit**
  ...
  * Prints the string `Last digit of [number] is [last_digit]` followed by:
    ...
    * Followed by a new line.
  * Completion of [this source code](https://github.com/ALXschool/0x01.py/blob/master/1-last_digit_py).
