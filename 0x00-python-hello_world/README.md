...
* **3. Print integer**
  ...
  * Completion of [this source code](https://github.com/ALXschool/0x00.py/blob/master/3-print_number.py).
...
* **4. Print float**
  ...
  * Completion of [this source code](https://github.com/ALXschool/0x00.py/blob/master/4-print_float.py).
...
* **5. Print string**
  ...
  * Completion of [this source code](https://github.com/ALXschool/0x00.py/blob/master/5-print_string.py).

* **6. Play with strings**
  * [6-concat.py](./6-concat.py): Python script that prints `Welcome to ALX
  School!` using the variables `str1 = "ALX"` and `str2 = "School"`.
  * Completion of [this source code](https://github.com/ALXschool/0x00.py/blob/master/6-concat.py).
...
* **7. Copy - Cut - Paste**
  ...
  * Completion of [this source code](https://github.com/ALXschool/0x00.py/blob/master/7-edges.py).
...
* **8. Create a new sentence**
  * [8-concat_edges.py](./8-concat_edges.py): Python script that prints `object-oriented
  ...
  string literals.
  * Completion of [this source code](https://github.com/ALXschool/0x00.py/blob/master/8-concat_edges.py).
